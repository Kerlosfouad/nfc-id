...
const PRESET_THEMES = [
  ...
  { id: "m-motorsport", name: "M Motorsport", desc: "Gloss white, carbon navy, cyan, and race red", colors: ["#f8fafc", "#050B14", "#00AEEF", "#DC2626"], premium: false, accent: "#00AEEF", coverUrl: "/assets/themes/motorsport-m.jpg" },
];
