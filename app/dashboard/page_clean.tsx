...
const PRESET_THEMES = [
  ...
  { id: "m-motorsport", name: "M Motorsport", desc: "Dark carbon, deep cyan, muted race red", colors: ["#020617", "#111827", "#0284C7", "#991B1B"], premium: false, accent: "#0284C7", coverUrl: "/assets/themes/motorsport-m.jpg" },
];
