...
const PRESET_THEMES = [
  ...
  { id: "m-motorsport", name: "M Motorsport", desc: "BMW blue, carbon navy, cyan, and race red", colors: ["#dbeafe", "#050B14", "#0054A6", "#DC2626"], premium: false, accent: "#0054A6", coverUrl: "/assets/themes/motorsport-m.jpg" },
];
