      ...
      <div className="container mx-auto">
        <div className="relative bg-gradient-to-br from-[#0f1a2e] to-[#0b0a0a] border border-[#03A9F4]/20 rounded-2xl p-5 sm:p-12 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/20 text-xs mt-6">{isArabic ? "لا تحتاج إلى بطاقة بنكية · توجد خطة مجانية دائمًا" : "No credit card required · Free forever plan available"}</p>
          </div>
        </div>
      </div>
    </section>
